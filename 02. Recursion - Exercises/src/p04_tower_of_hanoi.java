...
public class p04_tower_of_hanoi {

    private static final Deque<String> AUXILIARY = new ArrayDeque<>();
    private static final Deque<String> TARGET = new ArrayDeque<>();
    private static final Deque<String> SOURCE = new ArrayDeque<>();
