...
public class p01_sum_of_coins_tests {
    ...
    public void TestWithProvidedExample() {
        ...
        Map<Integer, Integer> selectedCoins = p01_sum_of_coins.chooseCoins(coins, targetSum);
    ...
    public void TestWithUnreachableSum() {
        ...
        p01_sum_of_coins.chooseCoins(coins, targetSum);
    }
